...
| ------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------- | ----------- |
| [02 — End activity ends with the reveal](02-end-activity-ends-with-the-reveal.md)                       | Students get a real ending (reveal included) at the bell, not a dead chat then a wipe     | Not started |
