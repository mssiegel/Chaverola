...
import { student as en } from "../locales/en/student";
import { student as he } from "../locales/he/student";

/*
  Side-effect module: importing it registers the `student` namespace for every
  locale. Imported at the top of the lazy page module(s) for the student join flow, so
