...
import { home as en } from "../locales/en/home";
import { home as he } from "../locales/he/home";

/*
  Side-effect module: importing it registers the `home` namespace for every
  locale. Imported at the top of the lazy page module(s) for the homepage, so
